          ...
          <div className="row mx-xl-5 mx-md-0 mx-2 pt-3">
            <div className="col-6 col-md-3 mb-4 mt-3 my-md-0 text-white  text-md-start">
              ...
              <p className="mb-2 mb-md-3">
                Hno:205 Near Upper Lake, Jaipur, Haryana Pin:34534
              </p>
              <p className="mb-2 mb-md-3">+91 9685759324</p>
              <p className="textoverflow mb-2 mb-md-3">krishnakhattri24@gmail.com</p>
